...
export function RoadmapSection({ className }: RoadmapSectionProps) {
	return (
		<section className={cn("relative bg-black w-full", className)}>
			...
			{/* Top line pattern */}
			<div className="absolute -top-12 rotate-2 left-0 right-0 h-[30px] md:h-[45px] bg-[repeating-linear-gradient(90deg,theme(colors.primary.DEFAULT),theme(colors.primary.DEFAULT)_10px,transparent_10px,transparent_20px)] md:bg-[repeating-linear-gradient(90deg,theme(colors.primary.DEFAULT),theme(colors.primary.DEFAULT)_15px,transparent_15px,transparent_30px)] opacity-60"></div>
